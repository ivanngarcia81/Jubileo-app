...
1. **Dashboard** *(inicio, ruta `#/resumen`)* — Resume y despacha, con la acción diaria adentro. Seis tarjetas, cada una con su enlace a la sección donde eso se arregla: **la semana en curso** (héroe turquesa con lo que queda en los sobres, con su arrastre, su rótulo —"Semana 2 · del 8 al 14"— y los chips de *Anotar*, *Pagué* y *Cerrar*), **cómo va el reparto** (lo gastado contra el ritmo del plan, no contra el plan a secas), **por revisar**, **lo que viene** (14 días), **salir de deudas** y **fondos de reserva**. *(La dirección vieja `#/semana` redirige aquí.)*
2. **Presupuesto mensual** *(ruta `#/mes`)* — Base cero. Selector de mes con barras (entra / sale / sobró) y el segmentado **Semanas · Cheques · Mes**.

   **La puerta decide el eje**, no lo que se miró la última vez. El destino del menú es para **mirar** —cuánto se fue en comida en todo el mes, cuánto en gasolina— y abre en **Mes**. Una semana del riel (`#/mes?semana=3`) es el **lugar de trabajo** —ahí se reparte y se marcan los pagos— y abre en **Semanas** con esa semana desplegada. El segmentado sigue sirviendo para cambiar de eje una vez dentro; lo que ya no hace es decidir a dónde llegas. En Semanas, las 4–5 del calendario con **Planeado, Gastado y Queda** y su bandera de apretada: adentro los fijos que caen por fecha —con su casilla para marcarlos pagados, la checklist— y los sobres editables por semana. En Cheques, la vista derivada con las mismas tres cifras bajo otros rótulos —**Entra, Cubre, Queda**—. En Mes, el árbol por grupos: mayordomía, fijos con su día, variables, deudas, y los fondos de reserva.
